...
<section class="section">
  <div class="container">
    ...
    <p>그래서 이 사이트는 “어느 구에 있나”보다 “호텔인지, 오피스텔인지, 업무지구인지, 야간인지”를 먼저 확인하도록 구성했습니다. 아래 이용 장소·시간대·생활벨트 안내에서 상황에 맞는 페이지를 고르시면, 해당 상황에서 확인하면 좋은 주소·건물 출입·예약 가능 시간 기준을 정리해 두었습니다. 방문 가능 여부는 실제 주소와 예약 조건을 확인한 뒤 안내드립니다.</p>
