...
현재 **전국 17개 시·도** + **주요 도시 9곳**(수원·성남·용인·고양·창원·청주·천안·전주·포항)을
동일 엔진으로 생성합니다(총 26개 지역). 도(道) 내 대도시는 구·생활권 단위로 심화 안내하며,
도 페이지의 해당 시(市) 카드에서 도시 허브로 상세 링크를 연결합니다(`meta.kind: 'city'`).
